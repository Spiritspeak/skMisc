...
#' @param ... Unquoted column names, paired with the desired class, e.g. \code{age = numeric(), language = character()}
#'
#' @export
#'
#' @examples 
...
#' @export
#'
#' @examples combobulate("Hello ",c("Sir","Madam"),", ",c("may I take your order?","what shall it be today?"))
#' # [1] "Hello Sir, may I take your order?"    
#' # [2] "Hello Madam, may I take your order?"   
#' # [3] "Hello Sir, what shall it be today?"  
#' # [4] "Hello Madam, what shall it be today?"
